...
function FlowChart() {
  ...
  <h2 className={styles.flowTitle}>HOW SAMARDHYA WORKS</h2>
    ...
    {[
      {
        ...
        desc: [
          "Your brain: “Bro… do something.”",
          "You: open Samardhya website."
        ]
      },
      {
      ...
      },
      {
        ...
        desc: [
          "You submit like a soldier returning from battle: Traumatized but leveled up."
        ]
      },
      {
